import torch
from mnist_classifier.models.fn import ImageClassifier
from mnist_classifier.models.cnn import ConvolutionClassifier
from mnist_classifier.models.lstm import SequenceClassifier
...
def get_model(input_size, output_size, config, device):
    if config.model == 'fc':
        ...
        model = SequenceClassifier(input_size=input_size,
